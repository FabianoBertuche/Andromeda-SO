...
export const ProvidersPanel: React.FC = () => {
    ...
    return (
        <div className="p-6 bg-slate-900 rounded-xl border border-slate-700 shadow-xl">
            ...
            <button className="mt-6 px-4 py-3 border border-dashed border-slate-600 text-slate-400 hover:text-white hover:border-blue-500 hover:bg-blue-500/5 rounded-lg transition-all w-full flex justify-center items-center gap-2">
